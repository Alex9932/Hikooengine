...
import alex9932.engine.Engine;
import alex9932.engine.render.GL;
import alex9932.engine.render.GuiShader;
...
public class ScriptsEngine {
	...
	public ScriptsEngine(Engine engine, GuiShader shader) {
		this.engine = engine;
		this.gl = new GL();
	...
	public int getFps() {
		return engine.getDisplay().getFps();
	}
