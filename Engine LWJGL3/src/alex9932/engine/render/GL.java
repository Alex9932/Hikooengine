...
public class GL {
	...
	public Texture loadTexture(String path) {
		return new Texture(TExTURE_PATH + path);
	}
	...
	public void texCoord2(float u, float v){
	...
	public void texCoord3(float u, float v, float w){
		GL11.glTexCoord3f(u, v, w);
	}
	
	public void drawImage(int x, int y, int w, int h, Texture texture) {
